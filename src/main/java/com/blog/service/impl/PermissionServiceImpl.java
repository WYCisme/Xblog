...
import com.blog.model.converter.PermissionForm2Permission;
...
public class PermissionServiceImpl extends ServiceImpl<PermissionMapper, Permission> implements PermissionService {
    ...
    public R update(PermissionForm permissionForm) {
        ...
        permission = PermissionForm2Permission.converter(permissionForm);
    ...
    @Override
    public R add(PermissionForm permissionForm) {
        Permission permission = PermissionForm2Permission.converter(permissionForm);
