...
public class ScheduleJobController {
    ...
    // @RequiresPermissions("back:schedule:list")
        public
        ModelAndView list(@RequestParam(defaultValue = "0") Integer page,
    ...
    // @RequiresPermissions("back:schedule:save")
        public @ResponseBody
        R save(ScheduleJob scheduleJob, BindingResult bindingResult) {
    ...
    // @RequiresPermissions("back:schedule:update")
        public @ResponseBody
        R update(@ModelAttribute @Valid ScheduleJob scheduleJob, BindingResult bindingResult) {
    ...
    // @RequiresPermissions("back:schedule:pause")
        public
        R pause(@RequestBody Long[] jobIds) {
    ...
    // @RequiresPermissions("back:schedule:resume")
        public
        R resume(@RequestBody Long[] jobIds) {
