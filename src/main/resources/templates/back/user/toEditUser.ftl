...
<form class="layui-form" action="/back/user/editUser"  method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="password" name="password" lay-verify="pass" placeholder="请输入密码" value="${(user.password)!''}"  autocomplete="off" class="layui-input">
        </div>
