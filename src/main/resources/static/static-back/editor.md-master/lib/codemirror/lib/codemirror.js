...
(function(mod) {
  ...
  function Display(place, doc, input) {
    ...
    // Used to track whether anything happened since the content menu
    // was opened.
  ...
  TextareaInput.prototype = copyObj({
    ...
    onContextMenu: function(e) {
      ...
      display.input.reset();
      // Adds "Select all" to content menu in FF
  ...
  // smallest indentation, which tends to need the least content to
  // parse correctly.
  ...
  function onFocus(cm) {
    ...
    if (!cm.state.focused) {
      ...
      // This test prevents this from firing when a content
  ...
  // To make the content menu work, we need to briefly unhide the
